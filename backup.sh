...
cat << EOF
USAGE:
backup [OPTIONS] /source_folder/ /destination_folder/
...
EXAMPLES:
backup -p 5 [/source_folder/] [/destination_folder/]
...
while getopts ":p:" opt; do
  case $opt in
    p)
      ...
      echo "Rotate Period in Days: "$ROTATE_PERIOD
      ;;
    \?)
...
tar zcvf $SOURCE_FOLDER/$TGZFILE $DESTINATION_FOLDER
